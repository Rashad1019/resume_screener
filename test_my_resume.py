"""Test the AI Resume Screener with Rashad's resume"""
...
# Direct path to your resume
resume_path = r"C:\Users\rasha_ejuf17z\Downloads\1.Business\Resumes\New\Rashad_F_WR.pdf"
...
try:
    ...
    print("\n[WARNING] Failed to parse JSON. Raw output:")
